...
"""
Who should subclass ThemedWidget?
Loader/spinner widgets
Custom toggles that draw circles/bars by hand
Annotation overlays
Icon widgets
Anything that calls QPainter.drawLine, drawEllipse, etc.

Who shouldn’t?
Standard QPushButton-like buttons
QCheckBox-style checkboxes
Basic layout containers
Tabs/Windows/Dialogs
"""
