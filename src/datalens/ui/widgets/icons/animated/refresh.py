...
class RefreshAnimator(ButtonIconAnimator):
    """
    Animate the refresh glyph by spinning it.
    ...
    def __init__(
        ...
        *,
        ...
        self._size = int(size)
        super().__init__(
            frame_supplier=lambda angle: refresh_icon(self._theme, size=self._size, rotation_deg=angle),
